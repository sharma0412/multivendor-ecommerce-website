                                ...
                                <div class="card">
                                    <div class="card-body">
                                     <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{route('addstaff')}}" class="btn-primary btn btn-md">Add Staff</a>
                                     </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>{{$val->email}}</td>
                                                    <td>
                                                        <form action="{{route('changestatus',$val->id)}}" method="post">
                                                               @csrf
                                                            @if($val->status == 1)
                                                    ...
                                                    <td><a href="{{route('addstaff','id='.$val->id)}}" class="btn-primary btn btn-md"><i class="far fa-edit"></i></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
