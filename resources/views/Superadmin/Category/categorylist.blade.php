                                ...
                                <div class="card">
                                    <div class="card-body">
                                     <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{route('addcategory')}}" class="btn-primary btn btn-md">Add Category</a>
                                     </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>{{$val->name}}</td>
                                                    <td>
                                                        <form action="{{route('categorystatus',$val->id)}}" method="post">
                                                               @csrf
                                                            @if($val->status == 1)
                                                    ...
                                                    <td><a href="{{route('addcategory','id='.$val->id)}}" class="btn-primary btn btn-md"><i class="far fa-edit"></i></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
