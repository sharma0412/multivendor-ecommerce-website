                    ...
                    <div class="card">
                        <div class="card-body">
                           <div class="d-flex justify-content-between align-items-center">
                               ...
                               <a href="{{route('addbanner')}}" class="btn-primary btn btn-md">Add Banner</a>
                           </div>
                       </p>
                        ...
                        <table id="datatable" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('bannerstatus',$val->id)}}" method="post">
                                         @csrf
                                         @if($val->status == 1)
                                 ...
                                 <td><a href="{{route('addbanner','id='.$val->id)}}" class="btn-primary btn btn-md"><i class="far fa-edit"></i></td>
                                 </tr>
                                 @endforeach
                             </tbody>
                         </table>
